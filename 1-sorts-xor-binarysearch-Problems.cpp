...
int main(int argc, char *argv[]) {
	...
	cout << vec1;
	int max = BestMeetingArrangement::getMax(vec1, 0, vec1.size());
	cout << "Max: " << max << endl;

	vector<int> smallSum{1, 3, 4, 2, 5};
	cout << "Small Sum: " << BestMeetingArrangement::smallSum(smallSum) << endl;

	vector<int> reversedPair{5, 4, 3, 2, 1};
	cout << reversedPair;
	cout << "All reversed pair: ";
	BestMeetingArrangement::reversedPair(reversedPair);
	cout << endl;

	vector<int> hollandFlag1{3, 5, 6, 7, 4, 3, 5, 8};
	cout << hollandFlag1;
	BestMeetingArrangement::hollandFlag(hollandFlag1, 5);
	cout << hollandFlag1;
	vector<int> hollandFlag2{3, 5, 6, 7, 4, 3, 5, 8};
	cout << hollandFlag2;
	BestMeetingArrangement::hollandFlagFull(hollandFlag2, 5);
	cout << hollandFlag2;

	vector<int> sortedLessK{3, 2, 1, 6, 5, 4, 9, 8, 7};
	cout << sortedLessK;
	cout << "After sorted: " << BestMeetingArrangement::sortedArrayLessK(sortedLessK, 3);
